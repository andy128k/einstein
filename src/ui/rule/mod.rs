    ...
    match *rule {
        Rule::Near(thing1, thing2) => {
            Brick::new(RECT_WIDE)
                ...
                .add(Brick::new(RECT_1_0).background(Background::Pattern(&HINT_NEAR_ICON, highlighted)))
        ...
        Rule::Direction(thing1, thing2) => {
            Brick::new(RECT_WIDE)
                ...
                .add(draw_thing(RECT_0_0, thing1, highlighted))
                .add(draw_thing(RECT_2_0, thing2, highlighted))
                .add(Brick::new(RECT_1_0).background(Background::Pattern(&HINT_SIDE_ICON, highlighted)))
        },
        ...
        Rule::Between(thing1, thing2, thing3) => {
            Brick::new(RECT_WIDE)
                ...
                .add(Brick::new(Rect::new((3 * TILE_WIDTH - 70) / 2, 0, 70, 15)).background(Background::Pattern(&HINT_BETWEEN_ICON, highlighted)))
        },
        _ => {
